...
function ArticleByID() {
  ...
  useEffect(() => {
    ...
    const getArticle = async () => {
      ...
      try {
        const res = await axios.get(`https://capstone-backend-3bgm.onrender.com/user-api/article/${id}`, { withCredentials: true });
  ...
  const toggleArticleStatus = async () => {
    ...
    try {
      const res = await axios.patch(
        "https://capstone-backend-3bgm.onrender.com/author-api/articles",
  ...
  const addComment = async (commentObj) => {
    ...
    let res = await axios.put("https://capstone-backend-3bgm.onrender.com/user-api/articles", commentObj, { withCredentials: true });
    if (res.status === 200) {
